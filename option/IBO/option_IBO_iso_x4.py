...
parser.add_argument('--data_test', type=str, default='Set5x2',
...
parser.add_argument('--epochs_uo', type=int, default=200,
                    help='number of epochs to train the whole network')
parser.add_argument('--epochs_lo', type=int, default=400,
                    help='number of epochs to train the whole network')
parser.add_argument('--epochs_ibo', type=int, default=600,
                    help='number of epochs to train the whole network')
...
parser.add_argument('--model_name', type=str, default='IBO_iso_x4',
